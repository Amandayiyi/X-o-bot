...
'''
Copy from python library packet: dialogflow-lite
    for adapting this system, some function could be changed
...
class Dialogflow(object):
    ...
    def text_request(self, text):
        ...
        return responses, result['result']['metadata']['isFallbackIntent']
